...
<head>
    ...
    <link href="${basePath}/static/metronic/assets/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css"/>
    <link href="${basePath}/static/metronic/assets/layouts/layout/css/themes/darkblue.min.css" rel="stylesheet"
